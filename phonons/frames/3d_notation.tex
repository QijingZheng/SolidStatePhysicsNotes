        ...
        \begin{center}
            ...
            \foreach \i in {0, 1, 2, 3}{
                \foreach \j in {0, 1, 2, 3}{
                    \draw[thin, draw=gray, densely dash dot] (\i, -0.3) -- ++(0, 0.3);
                    \draw[thin, draw=gray, densely dash dot] (\i,  3.0) -- ++(0, 0.3);
                    \draw[thin, draw=gray, densely dash dot] (-0.3, \j) -- ++(0.3, 0);
                    \draw[thin, draw=gray, densely dash dot] ( 3.0, \j) -- ++(0.3, 0);
                }
            }
